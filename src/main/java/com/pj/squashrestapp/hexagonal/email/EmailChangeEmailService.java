...
class EmailChangeEmailService {
    ...
    void sendEmail(final String email, final String name, final Locale locale, final String emailChangeLink) {
        ...
        model.put("primaryContent", messageSource.getMessage("message.emailChange.youHaveRequested", null, locale));

        model.put("clickMessage", messageSource.getMessage("message.emailChange.buttonText", null, locale));
