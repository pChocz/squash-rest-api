...
class EmailChangeEmailService {
  ...
  void sendEmail(
      final String email, final String name, final Locale locale, final String emailChangeLink) {

    final String preheader =
        messageSource.getMessage("message.emailChange.preheader", null, locale);
    ...
    model.put("link", emailChangeLink);
    ...
    model.put(
        "primaryContent",
        messageSource.getMessage("message.emailChange.youHaveRequested", null, locale));

    model.put(
        "clickMessage", messageSource.getMessage("message.emailChange.buttonText", null, locale));
    ...
    model.put(
        "secondaryContent",
        new String[] {
          messageSource.getMessage("message.emailChange.expirationNote", null, locale),
