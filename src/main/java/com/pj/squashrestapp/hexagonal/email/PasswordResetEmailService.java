...
class PasswordResetEmailService {
  ...
  void sendEmail(
    ...
    model.put(
        ...
        messageSource.getMessage("message.passwordReset.youHaveRequested", null, locale));
    model.put(
        "clickMessage",
        messageSource.getMessage("message.passwordReset.buttonText", null, locale));
    model.put(
        "copyLinkMessage", messageSource.getMessage("message.util.copyLink", null, locale));
    model.put("additionalNote", messageSource.getMessage("message.passwordReset.expirationNote", null, locale));
    model.put(
        "doNotReplyMessage",
