...
class PasswordResetEmailService {
  ...
  void sendEmail(
    ...
    final String preheader =
        messageSource.getMessage("message.passwordReset.preheader", null, locale);
    ...
    model.put(
        "clickMessage", messageSource.getMessage("message.passwordReset.buttonText", null, locale));
