...
public class FakeSetResult {
    ...
    AdditionalSetResult createAdditional(
            final int setNumber, final SetWinningType winningType, final int expectedWinningPoints) {
                    ...
                    case ADV_OF_2_ABSOLUTE -> {
                        ...
                        yield random < 12
                                ...
                                : random < 15
                                        ...
                                        : random < 17 ? expectedWinningPoints + 2 : expectedWinningPoints + 3;
                    }
    ...
    private int generateLoosingPoints(
            final SetWinningType winningType, final int expectedWinningPoints, final int realWinningPoints) {
        switch (winningType) {
            case ADV_OF_2_OR_1_AT_THE_END -> {
