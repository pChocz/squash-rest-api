...
public class FakeLeagueHallOfFame {
    ...
    public List<TrophyForLeague> create(final SeasonScoreboardDto seasonScoreboardDto, final List<Player> allPlayers) {
        ...
        final List<PlayerDto> playersOrderedByCountedPoints = seasonScoreboardDto.getSeasonScoreboardRows().stream()
                .sorted(Comparator.comparingInt(SeasonScoreboardRowDto::getCountedPoints)
                        .reversed())
        ...
        final List<PlayerDto> playersOrderedByPretendersCupPoints =
                seasonScoreboardDto.getSeasonScoreboardRows().stream()
                        .sorted(Comparator.comparingInt(SeasonScoreboardRowDto::getCountedPointsPretenders)
                                .reversed())
                        .map(SeasonScoreboardRowDto::getPlayer)
                        .collect(Collectors.toList());
