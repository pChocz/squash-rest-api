...
public class InitializerController {
    ...
    void createInitialDatabaseStructure(@RequestParam final MultipartFile initJson) throws IOException {
        final String initAllJsonContent = IOUtils.toString(initJson.getInputStream(), StandardCharsets.UTF_8);
    ...
    List<JsonXpPointsForRound> createXpPoints(
            @RequestParam final int firstPlacePoints, @RequestParam final int percentToSubstract) {

        final List<JsonXpPointsForRound> list = new ArrayList<>();

        final List<String> allSplits = List.of(
                "4", "5", "6", "7", "8", "4,4", "4,5", "5,4", "5,5", "5,6", "6,5", "6,6", "6,7", "7,6", "7,7", "4,5,5",
                "5,4,5", "5,5,4", "5,5,5", "5,5,6", "5,6,5", "6,5,5", "4,4,4,4", "4,4,4,5", "4,4,5,5");
