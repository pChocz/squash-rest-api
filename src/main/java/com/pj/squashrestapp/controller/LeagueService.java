...
public class LeagueService {
  ...
  public List<SeasonScoreboardDto> overalScoreboard(final Long leagueId) {
    ...
    final League league = EntityGraphReconstruct.reconstructLeague(setResultListForLeague, leagueId);
    final ArrayListMultimap<String, Integer> xpPointsPerSplit = xpPointsService.buildAll();
