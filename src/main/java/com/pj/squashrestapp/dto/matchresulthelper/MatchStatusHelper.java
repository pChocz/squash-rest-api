...
public class MatchStatusHelper {
    ...
    private MatchStatus determineMatchStatus(final List<SetStatus> setStatuses) {
        ...
        for (int i = 0; i < numberOfSets; i++) {
            ...
            final boolean isEnoughSetsFinished =
                    firstPlayerWonSets == numberOfSetsToWinMatch || secondPlayerWonSets == numberOfSetsToWinMatch;
    ...
    private boolean isFinalOrAreRemainingSetsEmpty(final int i, final List<SetStatus> setStatuses) {
        return i == setStatuses.size() - 1 || areRemainingSetsOfType(i, setStatuses, SetStatus.EMPTY);
    }
