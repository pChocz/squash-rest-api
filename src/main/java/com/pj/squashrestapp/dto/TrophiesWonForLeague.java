...
public class TrophiesWonForLeague {
    ...
    public TrophiesWonForLeague(
            final PlayerDto player, final LeagueDtoSimple league, final List<TrophyForLeague> trophiesForLeague) {

        this.player = player;
        this.league = league;
        this.trophiesPerSeason = new ArrayList<>();

        final List<Integer> listOfSeasonNumbers = trophiesForLeague.stream()
        ...
        for (final int seasonNumber : listOfSeasonNumbers) {
            ...
            final List<TrophyForLeague> seasonTrophies = trophiesForLeague.stream()
