...
class MatchStatusStandardHelperTest {
  ...
  void checkMatchStatus_FINISHED() {
    ...
    assertAll(
        ...
        () ->
            assertEquals(
                FINISHED, getStatusForStandardBestOf5Match("11:9", "11:6", "12:10", "n:n", "n:n")),
        () ->
            assertEquals(
                FINISHED, getStatusForStandardBestOf5Match("11:6", "11:9", "5:11", "11:8", "n:n")),
        () ->
            assertEquals(
                FINISHED, getStatusForStandardBestOf5Match("5:11", "11:1", "11:6", "7:11", "9:6")),
        () ->
            assertEquals(
                FINISHED,
                getStatusForStandardBestOf5Match("12:10", "12:11", "8:11", "6:11", "9:8")));
  }
  ...
  void checkMatchStatus_EMPTY() {
    assertAll(
        ...
        () ->
            assertEquals(
                EMPTY, getStatusForStandardBestOf5Match("n:n", "n:n", "n:n", "n:n", "n:n")));
  }
  ...
  void checkMatchStatus_ERROR() {
    ...
    assertAll(
        ...
        () ->
            assertEquals(
                ERROR, getStatusForStandardBestOf5Match("10:11", "11:9", "9:5", "n:n", "n:n")),
        () ->
            assertEquals(
                ERROR, getStatusForStandardBestOf5Match("n:n", "11:9", "9:5", "11:8", "n:n")),
        () ->
            assertEquals(
                ERROR, getStatusForStandardBestOf5Match("12:10", "11:9", "11:5", "11:8", "n:n")),
        () ->
            assertEquals(
                ERROR, getStatusForStandardBestOf5Match("n:n", "11:9", "11:6", "11:8", "n:n")),
        () ->
            assertEquals(
                ERROR, getStatusForStandardBestOf5Match("n:n", "n:n", "9:5", "n:n", "n:n")),
        () ->
            assertEquals(
                ERROR, getStatusForStandardBestOf5Match("14:10", "11:9", "9:5", "n:n", "n:n")));
  }
  ...
  void checkMatchStatus_IN_PROGRESS() {
    ...
    assertAll(
        ...
        () ->
            assertEquals(
                IN_PROGRESS, getStatusForStandardBestOf5Match("11:9", "n:n", "n:n", "n:n", "n:n")),
        () ->
            assertEquals(
                IN_PROGRESS, getStatusForStandardBestOf5Match("11:9", "11:5", "n:n", "n:n", "n:n")),
        () ->
            assertEquals(
                IN_PROGRESS,
                getStatusForStandardBestOf5Match("11:9", "11:5", "6:11", "6:11", "n:n")),
        () ->
            assertEquals(
                IN_PROGRESS,
                getStatusForStandardBestOf5Match("11:9", "12:10", "6:11", "6:11", "n:n")),
        () ->
            assertEquals(
                IN_PROGRESS,
                getStatusForStandardBestOf5Match("11:9", "12:10", "6:11", "6:11", "5:2")));
  }
