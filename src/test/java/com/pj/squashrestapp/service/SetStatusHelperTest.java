...
class SetStatusHelperTest {
    ...
    void checkSetStatus_FINISHED() {
        ...
        assertAll(
                ...
                () -> assertEquals(
                        FIRST_PLAYER_WINS, SetStatusHelper.checkStatus(new SetDto("11:8"), 11, ADV_OF_2_ABSOLUTE)),
                () -> assertEquals(
                        FIRST_PLAYER_WINS, SetStatusHelper.checkStatus(new SetDto("13:11"), 11, ADV_OF_2_ABSOLUTE)),
                () -> assertEquals(
                        SECOND_PLAYER_WINS, SetStatusHelper.checkStatus(new SetDto("12:14"), 11, ADV_OF_2_ABSOLUTE)),
                () -> assertEquals(
                        SECOND_PLAYER_WINS, SetStatusHelper.checkStatus(new SetDto("4:11"), 11, ADV_OF_2_ABSOLUTE)));
    ...
    void checkSetStatus_IN_PROGRESS() {
        assertAll(
                ...
                () -> assertEquals(
                        IN_PROGRESS, SetStatusHelper.checkStatus(new SetDto("10:8"), 11, ADV_OF_2_OR_1_AT_THE_END)),
                () -> assertEquals(
                        IN_PROGRESS, SetStatusHelper.checkStatus(new SetDto("11:10"), 11, ADV_OF_2_OR_1_AT_THE_END)),
                () -> assertEquals(
                        IN_PROGRESS, SetStatusHelper.checkStatus(new SetDto("4:10"), 11, ADV_OF_2_OR_1_AT_THE_END)),
                () -> assertEquals(
                        IN_PROGRESS, SetStatusHelper.checkStatus(new SetDto("0:5"), 11, ADV_OF_2_OR_1_AT_THE_END)));

        assertAll(
                "Assert - Set is IN PROGRESS - ADV_OF_2_ABSOLUTE",
                () -> assertEquals(
                        IN_PROGRESS, SetStatusHelper.checkStatus(new SetDto("11:10"), 11, ADV_OF_2_ABSOLUTE)),
                () -> assertEquals(
                        IN_PROGRESS, SetStatusHelper.checkStatus(new SetDto("13:12"), 11, ADV_OF_2_ABSOLUTE)),
                () -> assertEquals(IN_PROGRESS, SetStatusHelper.checkStatus(new SetDto("4:10"), 11, ADV_OF_2_ABSOLUTE)),
                () -> assertEquals(
                        IN_PROGRESS, SetStatusHelper.checkStatus(new SetDto("11:11"), 11, ADV_OF_2_ABSOLUTE)));

        assertAll(
                "Assert - Set is IN PROGRESS - WINNING_POINTS_ABSOLUTE",
                () -> assertEquals(
                        IN_PROGRESS, SetStatusHelper.checkStatus(new SetDto("9:8"), 11, WINNING_POINTS_ABSOLUTE)),
                () -> assertEquals(
                        IN_PROGRESS, SetStatusHelper.checkStatus(new SetDto("10:10"), 11, WINNING_POINTS_ABSOLUTE)),
                () -> assertEquals(
                        IN_PROGRESS, SetStatusHelper.checkStatus(new SetDto("3:9"), 11, WINNING_POINTS_ABSOLUTE)),
                () -> assertEquals(
                        IN_PROGRESS, SetStatusHelper.checkStatus(new SetDto("0:9"), 11, WINNING_POINTS_ABSOLUTE)));
    }
    ...
    void checkSetStatus_ERROR() {
        assertAll(
                ...
                () -> assertEquals(
                        ERROR, SetStatusHelper.checkStatus(new SetDto("12:7"), 11, ADV_OF_2_OR_1_AT_THE_END)),
                () -> assertEquals(
                        ERROR, SetStatusHelper.checkStatus(new SetDto("0:12"), 11, ADV_OF_2_OR_1_AT_THE_END)));
        ...
        assertAll(
                ...
                () -> assertEquals(
                        ERROR, SetStatusHelper.checkStatus(new SetDto("10:12"), 11, WINNING_POINTS_ABSOLUTE)));
    }
}
