...
class MatchStatusAdvantageOf2AbsoluteHelperTest {
  ...
  void checkMatchStatus_FINISHED() {
    ...
    assertAll(
        ...
        () ->
            assertEquals(
                FINISHED,
                getStatusForAbsDiffOf2BestOf5Match("11:9", "11:6", "12:10", "n:n", "n:n")),
        () ->
            assertEquals(
                FINISHED,
                getStatusForAbsDiffOf2BestOf5Match("11:6", "11:9", "5:11", "11:8", "n:n")),
        () ->
            assertEquals(
                FINISHED,
                getStatusForAbsDiffOf2BestOf5Match("5:11", "11:1", "11:6", "7:11", "9:6")),
        () ->
            assertEquals(
                FINISHED,
                getStatusForAbsDiffOf2BestOf5Match("12:10", "13:11", "8:11", "6:11", "10:8")));
  }
  ...
  void checkMatchStatus_EMPTY() {
    assertAll(
        ...
        () ->
            assertEquals(
                EMPTY, getStatusForAbsDiffOf2BestOf5Match("n:n", "n:n", "n:n", "n:n", "n:n")));
  }
  ...
  void checkMatchStatus_ERROR() {
    ...
    assertAll(
        ...
        () ->
            assertEquals(
                ERROR, getStatusForAbsDiffOf2BestOf5Match("10:11", "11:9", "9:5", "n:n", "n:n")),
        () ->
            assertEquals(
                ERROR, getStatusForAbsDiffOf2BestOf5Match("n:n", "11:9", "9:5", "11:8", "n:n")),
        () ->
            assertEquals(
                ERROR, getStatusForAbsDiffOf2BestOf5Match("12:10", "11:9", "11:5", "11:8", "n:n")),
        () ->
            assertEquals(
                ERROR, getStatusForAbsDiffOf2BestOf5Match("n:n", "11:9", "11:6", "11:8", "n:n")),
        () ->
            assertEquals(
                ERROR, getStatusForAbsDiffOf2BestOf5Match("n:n", "n:n", "9:5", "n:n", "n:n")),
        () ->
            assertEquals(
                ERROR, getStatusForAbsDiffOf2BestOf5Match("14:10", "11:9", "9:5", "n:n", "n:n")));
  }
  ...
  void checkMatchStatus_IN_PROGRESS() {
    ...
    assertAll(
        ...
        () ->
            assertEquals(
                IN_PROGRESS,
                getStatusForAbsDiffOf2BestOf5Match("11:9", "n:n", "n:n", "n:n", "n:n")),
        () ->
            assertEquals(
                IN_PROGRESS,
                getStatusForAbsDiffOf2BestOf5Match("11:9", "11:5", "n:n", "n:n", "n:n")),
        () ->
            assertEquals(
                IN_PROGRESS,
                getStatusForAbsDiffOf2BestOf5Match("11:9", "11:5", "6:11", "6:11", "n:n")),
        () ->
            assertEquals(
                IN_PROGRESS,
                getStatusForAbsDiffOf2BestOf5Match("11:9", "12:10", "6:11", "6:11", "n:n")),
        () ->
            assertEquals(
                IN_PROGRESS,
                getStatusForAbsDiffOf2BestOf5Match("11:9", "12:10", "6:11", "6:11", "5:2")));
  }

  private MatchStatus getStatusForAbsDiffOf2OneGameMatch(final String... setResults) {
    return new MatchSimpleDto(
            MatchFormatType.ONE_GAME, ADV_OF_2_ABSOLUTE, ADV_OF_2_ABSOLUTE, 11, 11, setResults)
        .getStatus();
  }

  private MatchStatus getStatusForAbsDiffOf2BestOf3Match(final String... setResults) {
    return new MatchSimpleDto(
            MatchFormatType.BEST_OF_3, ADV_OF_2_ABSOLUTE, ADV_OF_2_ABSOLUTE, 11, 9, setResults)
        .getStatus();
  }

  private MatchStatus getStatusForAbsDiffOf2BestOf5Match(final String... setResults) {
    return new MatchSimpleDto(
            MatchFormatType.BEST_OF_5, ADV_OF_2_ABSOLUTE, ADV_OF_2_ABSOLUTE, 11, 9, setResults)
        .getStatus();
  }
}
