...
class MatchStatusAdvantageOf2AbsoluteHelperTest {
  ...
  void checkMatchStatus_FINISHED() {
    ...
    assertAll(
        ...
        () -> assertEquals(FINISHED, getStatusForAbsDiffOf2BestOf5Match("12:10", "13:11", "8:11", "6:11", "10:8"))
    );
  }
  ...
  void checkMatchStatus_IN_PROGRESS() {
    ...
    assertAll(
        ...
        () -> assertEquals(IN_PROGRESS, getStatusForAbsDiffOf2BestOf5Match("11:9", "11:5", "n:n", "n:n", "n:n")),
        () -> assertEquals(IN_PROGRESS, getStatusForAbsDiffOf2BestOf5Match("11:9", "11:5", "6:11", "6:11", "n:n")),
        () -> assertEquals(IN_PROGRESS, getStatusForAbsDiffOf2BestOf5Match("11:9", "12:10", "6:11", "6:11", "n:n")),
        () -> assertEquals(IN_PROGRESS, getStatusForAbsDiffOf2BestOf5Match("11:9", "12:10", "6:11", "6:11", "5:2"))
    );
  }
